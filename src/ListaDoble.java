...
public class ListaDoble {
    ...
    void insertarCabeza(int valor) {
        ...
        // Si la lista no está vacía, se inserta el nuevo nodo
        ...
        cola.punteroCola = nuevoNodo;  // El último nodo apunta al nuevo nodo
        nuevoNodo.punteroCola = cabeza;  // El nuevo nodo apunta a la cabeza
        nuevoNodo.punteroCabeza = cola;  // El nuevo nodo apunta al antiguo último nodo

        cabeza = nuevoNodo;  // Actualiza la cabeza a ser el nuevo nodo
    ...
    void eliminarCola() {
        if (cabeza == null) {  // Verifica si la lista está vacía
            ...
            System.out.println("=========================================================\n");
            Nodo cola = cabeza.punteroCabeza.punteroCabeza;  // Obtiene el penúltimo nodo
            cola.punteroCola = cabeza;  // El penúltimo nodo apunta a la cabeza
            cabeza.punteroCabeza = cola;  // Actualiza el punteroCabeza de la cabeza
        }
        tamaño--;  // Decrementa el tamaño de la lista
    }
    ...
    void printLista() {
        ...
        Nodo nodo = cabeza.punteroCabeza;  // Comienza desde el último nodo
        System.out.print("\n*=============================================*\n\t");
        do {
            System.out.print(nodo.dato + " ");  // Imprime el valor del nodo actual
            nodo = nodo.punteroCabeza;  // Avanza al nodo anterior
        } while (nodo != cabeza.punteroCabeza);  // Continúa hasta que regrese a la cabeza
        System.out.println("\n*=============================================*\n");
    }

    // Método principal para ejecutar el programa y manejar el menú
    public static void iniciar() {
        ListaDoble lista = new ListaDoble();  // Crea una nueva lista doble vacía
